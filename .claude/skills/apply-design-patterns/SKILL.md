...
A recognize-and-apply pass over a single scope. The catalog of target shapes is `docs/design-patterns/` — the 23 GoF patterns remapped to altune's Go-hexagonal and RN/TS-functional stacks, each with a verdict (✅ live in repo · ◐ conceptual · ⊘ N/A) and a "when to skip it". Read its [README.md](../../../docs/design-patterns/README.md) for the full map and hold all 23 in view — this skill is about leveraging as many as honestly fit, not hunting one or two.
