...
- Project rules: `../../backend/go-dependency-injection.md` (no globals/service locator; composition root only), `../../backend/go-design-patterns.md` (avoid `init()` and mutable globals), `../../backend/go-concurrency.md` (`sync.Once` for lazy init)
