...
- Project rules: `../../../.claude/rules/backend/go-design-patterns.md` (functional options — preferred constructor form), `../../../.claude/rules/backend/go-code-style.md` (4+ params → options struct)
