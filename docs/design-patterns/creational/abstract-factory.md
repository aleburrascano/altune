...
- Project rules: `../../../.claude/rules/backend/go-structs-interfaces.md` (small interfaces, accept interfaces / return structs), `../../../.claude/rules/backend/go-dependency-injection.md` (wire at the composition root only)
