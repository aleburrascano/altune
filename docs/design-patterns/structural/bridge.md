...
- You only have one implementation of the second axis — discover the interface later (`../../../.claude/rules/backend/go-structs-interfaces.md`: "don't design with interfaces, discover them"), don't pre-split.
...
- Project rules: `../../../.claude/rules/backend/go-dependency-injection.md`, `../../../.claude/rules/backend/go-structs-interfaces.md`
