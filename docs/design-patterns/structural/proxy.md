...
- Project rules: `../../../.claude/rules/backend/go-safety.md` (useful zero values, Null Object), `../../../.claude/rules/backend/go-structs-interfaces.md`, `../../../.claude/rules/backend/application-layer.md` (ports)
