...
- Project rules: `../../../.claude/rules/backend/go-data-structures.md` (preallocation, copy semantics, `weak.Pointer` for caches), `../../../.claude/rules/backend/go-design-patterns.md`
