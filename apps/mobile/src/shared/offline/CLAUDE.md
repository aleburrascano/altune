...
- `__tests__/` — `pinnedFiles.test.ts`, `pinnedFiles.property.test.ts`, `invariants.test.ts`, `pinnedStore.actions.test.ts`, `pinnedStore.index.test.ts`, `pinnedStore.persistence.test.ts`, `pinnedStore.pinnedUri.test.ts`, `pinnedStore.property.test.ts`, `pinnedStore.worker.test.ts`, `pinnedStore.repin.test.ts`, `pinnedStore.reconcile.test.ts`, `OfflineReconcileBridge.test.tsx`.
