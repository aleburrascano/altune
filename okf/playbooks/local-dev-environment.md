...
`docker-compose.yml` carries no comments — the backend is comment-free — so any rationale about the local service set belongs in this playbook or `services/go-api/CLAUDE.md`.
