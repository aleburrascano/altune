...
func TestAlbumTracksLive_E2E(t *testing.T) {
	...
	spTracks, err := sp.GetAlbumTracks(ctx, domain.ProviderSpotify, "6HBXwJApSdQ7qjr4Komyst")
	if err != nil {
	...
	apTracks, err := ap.GetAlbumTracks(ctx, domain.ProviderAppleMusic, "1895185526")
	if err != nil {
